...
###### TDA Estático
	Son estructuras de datos cuyo tamaño se determina en tiempo de compilación (programación), la estructura es de tamaño fijo y nunca cambia. Ejemplos incluyen arrays y structs. Se gestionan en la pila de memoria.

###### TDA Dinámico
	Su tamaño se determina en tiempo de ejecución, la estructura es de tamaño variable y puede cambiar, utilizando memoria dinámica. Ejemplos son listas enlazadas, pilas y colas. Requieren una gestión cuidadosa de la memoria para evitar fugas.
